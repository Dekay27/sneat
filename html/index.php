        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="row">
                        <div class="col-lg-2 col-md-4 order-0">
                            <div class="card">
                                <div class="card-body">
                        ...
                        <div class="col-lg-2 col-md-4 order-2">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
...
<script>
    // JavaScript code to handle search input and fetch relevant results
    ...
    searchInput.addEventListener("input", function () {
        ...
        // Send an AJAX request to the PHP file to get relevant results
        if (searchValue !== "") {
            const xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function () {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    if (xhr.status === 200) {
                        // Populate the dropdown with relevant results
            ...
            xhr.open("GET", `get_search_results.php?query=${encodeURIComponent(searchValue)}`, true);
            xhr.send();
        } else {
