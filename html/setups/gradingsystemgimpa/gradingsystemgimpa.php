...
// Query the database
$result = $db->query('SELECT * FROM gradesystemgimpa ORDER BY Level ASC, UpperMark DESC');
...
<head>
    ...
    <title>GIMPA Grading System | ISMS - Integrated School Management System</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> GIMPA Grading Setup
                    </h4>

                    <div class="card">
                        <h5 class="card-header">List of GIMPA Grades</h5>
