...
// Query the database
$result = $db->query('SELECT * FROM hndgradingsystem');
...
<head>
    ...
    <title>HND Grading System | ISMS - Integrated School Management System</title>
                ...
                <div class="modal-content">
                    ...
                    <form action="dbsgradingsystem_code_insert.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-2">
                                <div class="col mb-3">
                                    <label for="insertClass" class="form-label">Class</label>
                                    <input
                                            type="text"
                                            id="insertClass"
                                            name="insertClass"
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> HND Grading Setup
                    </h4>

                    <div class="card">
                        <h5 class="card-header">List of HND Grades</h5>
                            ...
                            <table class="table">
                                ...
                                <?php foreach ($rows as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['GradeNumeric']; ?></td>
                                        <td>
...
<script>
    document.querySelectorAll(".edit-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let updateClass = row.cells[2].textContent; // Replace with the appropriate index
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let deleteClass = row.cells[2].textContent; // Replace with the appropriate index
