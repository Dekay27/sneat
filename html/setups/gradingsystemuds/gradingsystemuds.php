...
// Query the database
$result = $db->query('SELECT * FROM gradesystemuds ORDER BY Level ASC, UpperMark DESC');
...
<head>
    ...
    <title>UDS Grading Setup | ISMS - Integrated School Management System</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> UDS Grading Setup
                    </h4>

                    <div class="card">
                        <h5 class="card-header">List of UDS Grades</h5>
