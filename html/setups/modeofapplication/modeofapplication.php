...
<head>
    ...
    <title>Mode of Application | ISMS - Integrated School Management System</title>
        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="modeofapplication_insert.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col-3 mb-3">
                                    <label for="insertID" class="form-label">ID</label>
                                    <input
                                            type="text"
                                            id="insertID"
                                            name="insertID"
                                ...
                                <div class="col mb-3">
                                    <label for="insertLevelDescription" class="form-label">Mode of Application</label>
                                    <input
                                            type="text"
                                            id="insertLevelDescription"
                                            name="insertLevelDescription"
                                            class="form-control"
                                            placeholder="Enter Mode of Application"
                                    />
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="modeofapplication_code_update.php" method="POST">
                    ...
                    <form action="level_code_delete.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col mb-0">
                                    <label for="deleteModeofApplication" class="form-label">Mode of Application</label>
                                    <input
                                            type="text"
                                            name="deleteModeofApplication"
                                            id="deleteModeofApplication"
                                            class="form-control"
                                    />
                                </div>
                            </div>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> Mode of Application
                    </h4>

                    <div class="card">
                        <h5 class="card-header">List of Application Modes</h5>
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <?php foreach ($rows as $row) { ?>
                                    <tr>
                                        <td><strong><?php echo $row['IndexCode']; ?></strong></td>
                                        <td><?php echo $row['ModeofApplication']; ?></td>
                                        <td>
...
<script>
    document.querySelectorAll(".edit-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let updateModeofApplication = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("updateID").value = updateID;
            document.getElementById("updateModeofApplication").value = updateModeofApplication;
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let deleteModeofApplication = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("deleteID").value = deleteID;
            document.getElementById("deleteModeofApplication").value = deleteModeofApplication;
