    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> Edit Region Data </h5>
            </div>

            <form action="updateregion-state.php" method="POST">

                <div class="modal-body">

                    <div class="form-group">
                        <label> Region ID </label>
                        <input type="text" name="region_id" id="region_id" class="form-control" readonly>
                    </div>

                    <div class="form-group">
                        <label> Region Description </label>
                        <input type="text" name="region_description" id="region_description" class="form-control"
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> Region or State Setup
                    </h4>
    ...
    <script>
        $(document).ready(function () {
            $('.edit-button').on('click', function () {
                ...
                $('#region_id').val(data[0]);
                $('#region_description').val(data[1]);
