        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="academicyear_crud.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col mb-3">
                                    <label for="insertID" class="form-label">Year ID</label>
                                    <input
                                            type="text"
                                            id="insertID"
                                            name="insertID"
                                ...
                                <div class="col mb-3">
                                    <label for="insertAcademicYear" class="form-label">Academic Year</label
                                    <input
                                            type="text"
                                            id="insertAcademicYear"
                                            name="insertAcademicYear"
                                            class="form-control"
