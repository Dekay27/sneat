...
// Query the database
$result = $db->query('SELECT * FROM academicyear');
...
<head>
    ...
    <title>Academic Year Setup | ISMS - Integrated School Management System</title>
        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="academicyear_code_insert.php" method="POST">
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="academicyear_code_update.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col mb-3">
                                    <label for="updateID" class="form-label">Year ID</label>
                                    <input
                                            type="text"
                                            name="updateID"
                                            id="updateID"
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="academicyear_code_delete.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-1">
                                    <label for="deleteID" class="form-label">Year ID</label>
                                    <input
                                            type="text"
                                            name="deleteID"
                                            id="deleteID"
                                ...
                                <div class="col mb-1">
                                    <label for="deleteAcademicYear" class="form-label">Academic Year</label>
                                    <input
                                            type="text"
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> Academic Year System
                    </h4>
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-header">List of Academic Years</h5>
                        <div class="col">
                            <div class="table-responsive text-nowrap px-12 py-8">
                                <table id="datatableid" class="table">
                                    ...
                                    <?php foreach ($rows as $row) { ?>
                                        <tr>
                                            <td><strong><?php echo $row['YearCode']; ?></strong></td>
...
<script>
    document.querySelectorAll(".edit-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let updateAcademicYear = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("updateID").value = updateID;
            document.getElementById("updateAcademicYear").value = updateAcademicYear;
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let deleteAcademicYear = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("deleteID").value = deleteID;
            document.getElementById("deleteAcademicYear").value = deleteAcademicYear;
