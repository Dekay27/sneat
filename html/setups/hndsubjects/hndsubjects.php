...
// Query the database
$result = $db->query('SELECT * FROM hndsubjects');
...
<head>
    ...
    <title>HND Subjects | ISMS - Integrated School Management System</title>
        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="hndsubjects_code_insert.php" method="POST">
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="hndsubjects_code_update.php" method="POST">
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="hndsubjects_code_delete.php" method="POST">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> HND Subjects</h4>

                    <div class="card">
                        <h5 class="card-header">List of HND Subjects</h5>
