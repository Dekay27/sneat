...
// Query the database
$result = $db->query('SELECT * FROM olevelsubjects');
...
<head>
    ...
    <title>O Level Subject Setup | ISMS - Integrated School Management System</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> O Level Subject Setup
                    </h4>

                    <div class="card">
                        <h5 class="card-header">List of O Level Subjects</h5>
