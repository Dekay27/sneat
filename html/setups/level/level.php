...
// Query the database
$result = $db->query('SELECT * FROM level');
...
<head>
    ...
    <title>Level Setup | ISMS - Integrated School Management System</title>
        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="level_code_insert.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col-3 mb-3">
                                    <label for="insertLevelID" class="form-label">Level ID</label>
                                    <input
                                            type="text"
                                            id="insertLevelID"
                                            name="insertLevelID"
                                ...
                                <div class="col mb-3">
                                    <label for="insertLevelDescription" class="form-label">Level Description</label>
                                    <input
                                            type="text"
                                            id="insertLevelDescription"
                                            name="insertLevelDescription"
                                            class="form-control"
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="level_code_update.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2 mb-3">
                                <div class="col-3 mb-0">
                                    <label for="updateLevelID" class="form-label">Level ID</label>
                                    <input
                                            type="text"
                                            name="updateLevelID"
                                            id="updateLevelID"
                                ...
                                <div class="col mb-0">
                                    <label for="updateLevelDescription" class="form-label">Level Description</label>
                                    <input
                                            type="text"
                                            name="updateLevelDescription"
                                            id="updateLevelDescription"
                                            class="form-control"
                                    />
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="level_code_delete.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2 mb-3">
                                <div class="col-3 mb-0">
                                    <label for="deleteLevelID" class="form-label">Level ID</label>
                                    <input
                                            type="text"
                                            name="deleteLevelID"
                                            id="deleteLevelID"
                                ...
                                <div class="col mb-0">
                                    <label for="deleteLevelDescription" class="form-label">Level Description</label>
                                    <input
                                            type="text"
                                            name="deleteLevelDescription"
                                            id="deleteLevelDescription"
                                            class="form-control"
                                    />
                                </div>
                            </div>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> Level Setup</h4>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <?php foreach ($rows as $row) { ?>
                                    <tr>
                                        <td><strong><?php echo $row['LevelID']; ?></strong></td>
...
<script>
    document.querySelectorAll(".edit-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let updateLevelID = row.cells[0].textContent; // Replace with the appropriate index
            let updateLevelDescription = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("updateLevelID").value = updateLevelID;
            document.getElementById("updateLevelDescription").value = updateLevelDescription;
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            // Extract data from the row (adjust these lines based on your actual table structure)
            let deleteLevelID = row.cells[0].textContent; // Replace with the appropriate index
            let deleteLevelDescription = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("deleteLevelID").value = deleteLevelID;
            document.getElementById("deleteLevelDescription").value = deleteLevelDescription;
