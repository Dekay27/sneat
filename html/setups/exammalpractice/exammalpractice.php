...
// Query the database
$result = $db->query('SELECT * FROM resultprocessing WHERE Malpractice IS NOT NULL');
...
<head>
    ...
    <title>Exam Malpractice | ISMS - Integrated School Management System</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Reports /</span> Exam Malpractice
                    </h4>

                    <div class="card">
                        <h5 class="card-header">List of Offenders</h5>
                            ...
                            <table class="table">
                                ...
                                <?php foreach ($rows as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['Malpractice']; ?></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
