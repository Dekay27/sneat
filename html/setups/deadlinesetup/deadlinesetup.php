...
// Query the database
$result = $db->query('SELECT * FROM deadline');
...
<head>
    ...
    <title>Deadline Setup | ISMS - Integrated School Management System</title>
        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="deadlinesetup_code_insert.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2">
                                <div class="col mb-3">
                                    <label for="insertID" class="form-label">Course Code</label>
                                    <input
                                            type="text"
                                            id="insertID"
                                            name="insertID"
                                ...
                                <div class="col mb-3">
                                    <label for="insertDescription" class="form-label">Course Name</label>
                                    <input
                                            type="text"
                            ...
                            <div class="row g-2">
                                <div class="col mb-3">
                                    <label for="insertDeadlineDate" class="form-label">DeadlineDate</label>
                                    <input
                                            type="text"
                                            id="insertDeadlineDate"
                                            name="insertDeadlineDate"
                                            class="form-control"
                                ...
                                <div class="col mb-3">
                                    <label for="insertResultsDeadline" class="form-label">Certificate type</label>
                                    <input
                                            type="text"
                                            id="insertResultsDeadline"
                                            name="insertResultsDeadline"
                                            class="form-control"
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="deadlinesetup_code_update.php" method="POST">
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="deadlinesetup_code_delete.php" method="POST">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Setup /</span> Deadline Setup</h4>

                    <div class="card">
                        <h5 class="card-header">List of Deadlines</h5>
...
<script>
    document.querySelectorAll(".edit-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let updateDescription = row.cells[1].textContent; // Replace with the appropriate index
            let updateDeadlineDate = row.cells[2].textContent; // Replace with the appropriate index
            let updateResultsDeadline = row.cells[3].textContent; // Replace with the appropriate index
            ...
            document.getElementById("updateDeadlineDate").value = updateDeadlineDate;
            document.getElementById("updateResultsDeadline").value = updateResultsDeadline;
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let deleteDescription = row.cells[1].textContent; // Replace with the appropriate index
            let deleteDeadlineDate = row.cells[2].textContent; // Replace with the appropriate index
            let deleteResultsDeadline = row.cells[3].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("deleteID").value = deleteID;
            document.getElementById("deleteDescription").value = deleteDescription;
            document.getElementById("deleteDeadlineDate").value = deleteDeadlineDate;
            document.getElementById("deleteResultsDeadline").value = deleteResultsDeadline;
