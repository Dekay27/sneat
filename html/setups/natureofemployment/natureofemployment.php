        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="natureofemployment_code_insert.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2">
                                ...
                                <div class="col mb-3">
                                    <label for="insertLevelDescription" class="form-label">Nature of Employment</label>
                                    <input
                                            type="text"
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="natureofemployment_code_update.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col mb-0">
                                    <label for="updateNatureofEmployment" class="form-label">Nature of
                                        Employment</label>
                                    <input
                                            type="text"
                                            name="updateNatureofEmployment"
                                            id="updateNatureofEmployment"
                                            class="form-control"
                                    />
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="natureofemployment_code_delete.php" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col mb-0">
                                    <label for="deleteNatureofEmployment" class="form-label">Nature of
                                        Employment</label>
                                    <input
                                            type="text"
                                            name="deleteNatureofEmployment"
                                            id="deleteNatureofEmployment"
                                            class="form-control"
                                    />
                                </div>
                            </div>
...
<script>
    document.querySelectorAll(".edit-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let updateNatureofEmployment = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("updateID").value = updateID;
            document.getElementById("updateNatureofEmployment").value = updateNatureofEmployment;
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let deleteNatureofEmployment = row.cells[1].textContent; // Replace with the appropriate index

            // Populate the form fields in the modal with extracted data
            document.getElementById("deleteID").value = deleteID;
            document.getElementById("deleteNatureofEmployment").value = deleteNatureofEmployment;
