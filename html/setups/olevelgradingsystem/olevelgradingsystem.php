...
// Query the database
$result = $db->query('SELECT * FROM olevelgradingsystem ORDER BY RecordKey');
        ...
        <div class="modal fade" id="modalInsert" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="olevelgradingsystem_code_insert.php" method="POST">
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="olevelgradingsystem_code_update.php" method="POST">
        ...
        <div class="modal fade" id="modalDelete" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="olevelgradingsystem_code_delete.php" method="POST">
...
<script>
    document.querySelectorAll(".delete-icon").forEach(function (icon) {
        icon.addEventListener("click", function () {
            ...
            let deleteNumericGrade = row.cells[2].textContent;
