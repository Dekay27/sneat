...
<head>
    ...
    <title>Upload Photo & Certs | ISMS - Integrated School Management System</title>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4 text-center">File Upload (Picture, Certificates, Results Slip, and
                        Payment Slip)</h4>

                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Please select your photo file for upload (Max
                                    25MB):</label>
                                <input class="form-control" type="file" id="formFile"/>
                            </div>
                            <hr>
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Please select your certificates and results
                                    slips for upload (Max 25MB):</label>
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="uploadData" class="btn btn-primary" href="">
                                Upload All Files
                            </button>
                        </div>
                    </div>
